...
"[project]/src/app/dashboard/admin/members/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UsersPage() {
    ...
    const [mes, setMes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchUsers = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/company-members/find/by-company/${isAdmin?.company}`);
            setUsers(data);
            const comp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/company/${isAdmin?.company}`);
    ...
    const deleteUser = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/company-members/${companyid}/${id}`);
    ...
    const addUser = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/company-members/`, {
                user_id: userid,
...
_s(UsersPage, "DKsdxP/tsr37xxNPz0ezUwL/zPI=", false, function() {
    return [
...
//# sourceMappingURL=src_app_dashboard_admin_members_page_tsx_255efa11._.js.map