        ...
        "ProjectsPage.useEffect": ()=>{
            const fetchProjects = {
                "ProjectsPage.useEffect.fetchProjects": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/user-project/${userId}`);
...
_s(ProjectsPage, "l9aMCeSFs5tSSHeY2A7ZgRpbEcU=", false, function() {
    return [
...
//# sourceMappingURL=src_app_dashboard_project_page_tsx_5b1e6bd7._.js.map