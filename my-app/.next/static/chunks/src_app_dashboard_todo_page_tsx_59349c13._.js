...
function TodosPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TodosPage.useEffect": ()=>{
            const fetchTodos = {
                "TodosPage.useEffect.fetchTodos": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/user-todo/${userId}`);
                        setTodos(data);
                    } catch (err) {
                        setError('Failed to fetch TODOs');
                    }
                }
            }["TodosPage.useEffect.fetchTodos"];
            if (userId) fetchTodos();
        }
    }["TodosPage.useEffect"], [
        userId
    ]);
    const cycleStatus = async (todo)=>{
        const currentIndex = STATUS_CYCLE.indexOf(todo.todo_status || 'Pending');
        const nextStatus = STATUS_CYCLE[(currentIndex + 1) % STATUS_CYCLE.length];
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/todo/${todo.todo_id}`, {
                todo_status: nextStatus
            });
            setTodos((prev)=>prev.map((t)=>t.todo_id === todo.todo_id ? {
                        ...t,
                        todo_status: nextStatus
                    } : t));
        } catch (err) {
                ...
                children: todos.map((todo)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    todo.due_date && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        children: [
                                            "Due: ",
...
_s(TodosPage, "x+L5JOVutis8JcgQ8prMcFqP9xc=", false, function() {
    return [
...
//# sourceMappingURL=src_app_dashboard_todo_page_tsx_59349c13._.js.map