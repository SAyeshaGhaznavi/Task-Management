...
function DashboardHome() {
    _s();
    const { user, handleLogout, isAdmin, setIsAdmin, companies, setCompanies } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardHome.useEffect": ()=>{
            const fetchCompanies = {
                "DashboardHome.useEffect.fetchCompanies": async ()=>{
                    try {
                        ...
                        const detailedCompanyPromises = data.map({
                            "DashboardHome.useEffect.fetchCompanies.detailedCompanyPromises": (company)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/company-members/${company.company_id}/${userId}`)
                        }["DashboardHome.useEffect.fetchCompanies.detailedCompanyPromises"]);
                        ...
                        const adminCompany = detailedCompanyMemberships.find({
                            "DashboardHome.useEffect.fetchCompanies.adminCompany": (company)=>company.user_role === 'ADMIN'
                        }["DashboardHome.useEffect.fetchCompanies.adminCompany"]);
                        if (adminCompany) {
                            setIsAdmin({
                                type: true,
            ...
            }["DashboardHome.useEffect.fetchCompanies"];
            if (userId) {
                fetchCompanies();
            }
        }
...
_s(DashboardHome, "9y5/r6XUJ+Bq20ZZN2VtlnshgVk=", false, function() {
    return [
